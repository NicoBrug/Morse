...
public:
    ...
    /**
     * @brief ROS topic prefix usage.
     * @warning DEPRECATED : TODO : To remove
     * 
     * This boolean flag indicates whether to use a ROS (Robot Operating System) topic prefix. 
     * When enabled, topic names follow ROS conventions.
     * 
     * Default: false.
     */
    bool bUseRosPrefix = false;
};
...
public:
    ...
    {
        /** ----- HISTORY ----- */
        dds_history_kind_t HistoryKind;
        ...
        /** ----- RELIABILITY ----- */
        dds_reliability_kind_t ReliabilityKind;
        ...
        /** ----- DURABILITY ----- */
        dds_durability_kind_t DurabilityKind;
        ...
        /** ----- LIVENESS ----- */
        dds_liveliness_kind_t LivenessKind;
    	...
    	/** ----- OWNERSHIP ----- */
    	dds_ownership_kind OwnershipKind;
    	...
    	/** ----- CONSISTENCY ----- */
    	dds_type_consistency_kind_t ConsistencyKind;
