/****************************************************************
  ...
  File name: C:\Dev\DataTypes\COMPILED/msg/BoundedArrayNested.c
  Source: C:\Dev\DataTypes\ROS\test_msgs\msg\BoundedArrayNested.idl
  Cyclone DDS: V0.11.0

*****************************************************************/
#include "BoundedArrayNested.h"

static const uint32_t test_msgs_msg_BoundedArrayNested_ops [] =
{
  /* BoundedArrayNested */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_BSQ | DDS_OP_SUBTYPE_STU, offsetof (test_msgs_msg_BoundedArrayNested, primitive_values), 4u, sizeof (test_msgs_msg_Primitives), (5u << 16u) + 6u /* Primitives */,
  DDS_OP_RTS,
...
const dds_topic_descriptor_t test_msgs_msg_BoundedArrayNested_desc =
{
  .m_size = sizeof (test_msgs_msg_BoundedArrayNested),
  .m_align = dds_alignof (test_msgs_msg_BoundedArrayNested),
  .m_flagset = 0u,
  .m_nkeys = 0u,
  .m_typename = "test_msgs::msg::BoundedArrayNested",
  .m_keys = NULL,
  .m_nops = 19,
  .m_ops = test_msgs_msg_BoundedArrayNested_ops,
  .m_meta = ""
};
