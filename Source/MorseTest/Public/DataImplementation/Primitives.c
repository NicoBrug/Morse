/****************************************************************
  ...
  File name: C:\Dev\DataTypes\COMPILED/msg/Primitives.c
...
static const uint32_t test_msgs_msg_Primitives_ops [] =
{
  /* Primitives */
  DDS_OP_DLC,
...
const dds_topic_descriptor_t test_msgs_msg_Primitives_desc =
{
  .m_size = sizeof (test_msgs_msg_Primitives),
  .m_align = dds_alignof (test_msgs_msg_Primitives),
  .m_flagset = 0u,
  .m_nkeys = 0u,
  .m_typename = "test_msgs::msg::Primitives",
  .m_keys = NULL,
  .m_nops = 16,
  .m_ops = test_msgs_msg_Primitives_ops,
  .m_meta = ""
};
