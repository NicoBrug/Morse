...
public:
    ...
    */
    ...
    {
        MRSConvertUtils::SequenceToTArray<bool, bool>(InData.bool_values._buffer, BoolValues, InData.bool_values._length);
        MRSConvertUtils::SequenceToTArray<uint8, uint8>(InData.byte_values._buffer, ByteValues, InData.byte_values._length);
        MRSConvertUtils::SequenceToTArray<char, unsigned char>(InData.char_values._buffer, CharValues, InData.char_values._length);
        MRSConvertUtils::SequenceToTArray<float, float>(InData.float32_values._buffer, Float32Values, InData.float32_values._length);
        MRSConvertUtils::SequenceToTArray<double, double>(InData.float64_values._buffer, Float64Values, InData.float64_values._length);
        MRSConvertUtils::SequenceToTArray<uint8, int8>(InData.int8_values._buffer, Int8Values, InData.int8_values._length);
        MRSConvertUtils::SequenceToTArray<uint8, uint8>(InData.uint8_values._buffer, Uint8Values, InData.uint8_values._length);
        MRSConvertUtils::SequenceToTArray<int16, int16>(InData.int16_values._buffer, Int16Values, InData.int16_values._length);
        MRSConvertUtils::SequenceToTArray<uint16, uint16>(InData.uint16_values._buffer, Uint16Values, InData.uint16_values._length);
        MRSConvertUtils::SequenceToTArray<int32, int32>(InData.int32_values._buffer, Int32Values, InData.int32_values._length);
        MRSConvertUtils::SequenceToTArray<uint32, unsigned int>(InData.uint32_values._buffer, Uint32Values, InData.uint32_values._length);
        MRSConvertUtils::SequenceToTArray<int64_t, int64>(InData.int64_values._buffer, Int64Values, InData.int64_values._length);
        MRSConvertUtils::SequenceToTArray<uint64_t, uint64>(InData.uint64_values._buffer, Uint64Values, InData.uint64_values._length);
        MRSConvertUtils::StrSequenceToTArray<char*, FString>(InData.string_values._buffer, StringValues, InData.string_values._length);
        Check = InData.check;
    };
    ...
    void UEToDDS (test_msgs_msg_DynamicArrayPrimitives& OutData) 
    {
        ...
        MRSConvertUtils::TArrayToSequence<bool, bool>(BoolValues, OutData.bool_values._buffer, BoolValues.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint8, uint8>(ByteValues, OutData.byte_values._buffer, ByteValues.Num());
        ...
        MRSConvertUtils::TArrayToSequence<char, unsigned char>(CharValues, OutData.char_values._buffer, CharValues.Num());
        ...
        MRSConvertUtils::TArrayToSequence<float, float>(Float32Values, OutData.float32_values._buffer, Float32Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<double, double>(Float64Values, OutData.float64_values._buffer, Float64Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint8, int8>(Int8Values, OutData.int8_values._buffer, Int8Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint8, uint8>(Uint8Values, OutData.uint8_values._buffer, Uint8Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<int16, int16>(Int16Values, OutData.int16_values._buffer, Int16Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint16, uint16>(Uint16Values, OutData.uint16_values._buffer, Uint16Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<int32, int32>(Int32Values, OutData.int32_values._buffer, Int32Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint32, unsigned int>(Uint32Values, OutData.uint32_values._buffer, Uint32Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<int64_t, int64>(Int64Values, OutData.int64_values._buffer, Int64Values.Num());
        ...
        MRSConvertUtils::TArrayToSequence<uint64_t, uint64>(Uint64Values, OutData.uint64_values._buffer, Uint64Values.Num());
        ...
        MRSConvertUtils::StrTArrayToSequence<char*, FString>(StringValues, OutData.string_values._buffer, StringValues.Num());
        OutData.check = Check;
    };
